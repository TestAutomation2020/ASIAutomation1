...
public class ValidationOfDuplicateUser extends BasePage {
    ...
    @FindBy(how = How.XPATH, using = "//div[@data-ref='inputEl'][contains(.,'2021-JAN-19')]")
    private WebElement EditDate;

    public ValidationOfDuplicateUser(WebDriver webDriver) {
        super(webDriver);
    }
